...
namespace Application.Visualization.Led
{
    public class Ws281xLedVisualizer : IVisualizer
    {
        ...
        public Ws281xLedVisualizer(IOptionsMonitor<DynamicSettings> dynamicSettings, IOptionsMonitor<StaticSettings> staticSettings)
        {
        ...
        public void Start()
        {
            ...
            this.InitLedStrip(this.dynamicSettings.CurrentValue.LedCount, this.staticSettings.CurrentValue.LedUpdateFrequency);
        }

        private void InitLedStrip(int pixels, int ledUpdateFrequency) 
        {
        ...
        public void UpdateColors(Color[] colors)
        {
            ...
            if (colors.Length != this.controller.LEDCount || this.currentUpdateFrequency != this.staticSettings.CurrentValue.LedUpdateFrequency)
            {
                this.Dispose();
                this.InitLedStrip(colors.Length, this.staticSettings.CurrentValue.LedUpdateFrequency);
            }
